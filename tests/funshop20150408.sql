...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES ('1', '0', 'Массивная доска', 'mobile', '1', '', '', '', '', '50', '1', '1422858315', '1422858315', '0', '0', '', '', '');
INSERT INTO `category` VALUES ('2', '0', 'Штучный паркет', 'computer', '1', '', '', '', '', '50', '1', '1422858539', '1422858539', '0', '0', '', '', '');
INSERT INTO `category` VALUES ('3', '1', 'Производитель', 'iphone', '1', '', '', '', '', '50', '1', '1422858566', '1422858566', '0', '0', '', '', '');
INSERT INTO `category` VALUES ('4', '1', 'Страна производитель', 'sansung', '1', '', '', '', '', '50', '1', '1422858593', '1422858593', '0', '0', '', '', '');
INSERT INTO `category` VALUES ('5', '2', 'Производитель', '', '0', '', '', 'Производитель', '', '50', '1', '1424857244', '1424857244', '0', '0', '', '', '');
INSERT INTO `category` VALUES ('6', '2', 'Страна производитель', '', '0', '', '', 'Страна производитель', '', '50', '1', '1424857273', '1424857273', '0', '0', '', '', '');
INSERT INTO `category` VALUES ('7', '2', 'Порода дерева', '', '0', '', '', '', '', '50', '1', '1424857318', '1424857318', '0', '0', '', '');
...
-- Records of profile
-- ----------------------------
INSERT INTO `profile` VALUES ('1', 'Administration', 'Site', null, '1', null, '0', '0', '0', '0', '+341243123123');
INSERT INTO `profile` VALUES ('4', null, '', null, '1', '2004-11-30 00:00:00', '1', '150000', '150200', '150202', '+341243123123');
...
CREATE TABLE `settings` (
  ...
  `seo_categories_description` text DEFAULT NULL,
...
-- Records of order_log
-- ----------------------------
INSERT INTO `settings` (name, status, description, logo, phone, email, policy, address, work_hours, seo_title, seo_description) VALUES ('Ru-parket', 1,
 'Ru-parket online store', '/upload/logo.svg', '+7 (495) 662-98-97', 'info@ru-parket.ru',
 '<p>Обращаясь в наш магазин, вы даете согласие <br>на обработку ваших персональных данных.<br>Обратите внимание: изображение товара на сайте <br>может отличаться от фактического изображения товара.<br>Информация на сайте xn--80akosecqc.ru не является публичной офертой.</p>',
 'Москва, Каширское шоссе, Д.2, корп.1',
 '<tr><td>Пн-Сб:</td><td>9:00 - 19:00</td></tr><tr><td>Вс:</td><td>9:00 - 17:00</td></tr>',
 'SEO-Текст',
 '<p>Далеко-далеко за словесными горами в стране гласных и согласных живут рыбные тексты. Вдали от
                        ...
                        страна</p>
                    <img src="/img/seo-pic.png" class="float float-left" alt="seo picture">
                    <p>Далеко-далеко за словесными горами в стране гласных и согласных живут рыбные тексты. Вдали от
                        всех живут они в буквенных домах на берегу Семантика большого языкового океана. Маленький ручеек
                        Даль журчит по всей стране и обеспечивает ее всеми необходимыми.</p>
                    <ul>
                    ...
                    <p>Далеко-далеко за словесными горами в стране гласных и согласных живут рыбные тексты. Вдали от
                        всех живут они в буквенных домах на берегу Семантика большого языкового океана. Маленький ручеек
                        Даль журчит по всей стране и обеспечивает ее всеми необходимыми правилами. Эта парадигматическая
                        страна, в которой жаренные члены предложения залетают прямо в рот. Даже всемогущая пунктуация не
                        имеет власти над рыбными текстами, ведущими безорфографичный образ жизни. Однажды одна маленькая
                        строчка рыбного текста по имени Lorem ipsum.</p>
                    <a href="#" class="border-bottom" title="Перейти">
                        <span>Подробнее...</span>
                    </a>'
 );
...
-- Records of order_log
-- ----------------------------
INSERT INTO `banner` (name, status, description_big, description_small, image) VALUES ('banner 1', 1, 'Никто не уйдет без подарка', 'Подарок гарантирован каждому покупателю', '/upload/banners/banner1.jpg');
INSERT INTO `banner` (name, status, description_big, description_small, image) VALUES ('banner 2', 1, 'Никто не уйдет без подарка', 'Подарок гарантирован каждому покупателю', '/upload/banners/banner2.jpg');
INSERT INTO `banner` (name, status, description_big, description_small, image) VALUES ('banner 3', 1, 'Никто не уйдет без подарка', 'Подарок гарантирован каждому покупателю', '/upload/banners/banner3.jpg');
...
-- Records of order_log
-- ----------------------------
INSERT INTO `static_pages` (header, header_down, status, alias, body) VALUES ('О компании', 'Наши преимущества', 1, 'about', '<div class="col-sm-6 col-lg-5">
...
INSERT INTO `static_pages` (header, status, alias, body) VALUES ('Наши клиенти', 1, 'our-clients', '<div class="col-lg-10">
                    <div class="row">
                        <div class="col-sm-6">
                            <article class="clearfix post">
                                <figure class="post-img">
...
INSERT INTO `static_pages` (header, status, alias, body) VALUES ('Наши партнеры', 1, 'our-partners', '<div class="col-lg-10">
                    <div class="row">
                        <div class="col-sm-6">
                            <article class="clearfix post">
                                <figure class="post-img">
...
INSERT INTO `static_pages` (header, status, alias, body) VALUES ('Наши проекти', 1, 'our-projects', '<div class="col-lg-10">
                    <div class="row">
                        <div class="col-sm-6">
                            <article class="clearfix post">
                                <figure class="post-img">
...
INSERT INTO `static_pages` (header, status, alias, body) VALUES ('Оплата и доставка', 1, 'payment-delivery', '<div class="col-lg-10">
...
INSERT INTO `static_pages` (header, status, alias, body) VALUES ('Сервис', 1, 'service', '<div class="col-lg-10">
                    <div class="h2 text-center">Семь причин заказать "Паркетные работы" именно у нас.</div>
                    <div class="row">
                        <div class="col-sm-6">
                            <article class="clearfix post">
...
INSERT INTO `static_pages` (header, header_down, status, alias, body) VALUES ('Гарантия', 'Качество товара и гарантия на товар', 1, 'warranty', '<div class="col-lg-5">
			<article class="clearfix post">
				<figure class="post-img">
					<img src="..//img/about-1.jpg" class="" alt="seo picture">
				</figure>
...
INSERT INTO `attribute_group` (`id`, `sort_order`, `name`) VALUES
(3, 2, 'Memory'),
(4, 1, 'Technical'),
(5, 3, 'Motherboard'),
(6, 4, 'Processor');
