...
//        $arraySameRootCategory = Category::getArraySubCatalogId($rootCategoryId, $allCategory);
        ...
        $sameCategoryProducts = Product::find()->where(['category_id' => $model->category_id])->orderBy(['sales' => SORT_DESC])->limit(6)->all();
...
//        }
    ...
    {
        $subCatFirstLevel = Category::find()->where(['parent_id' => 0])->all();
