...
<main class="main" role="main">
    ...
    <section class="categories">
        <div class="container">
            ...
            <div class="h1"><?= $rootCategory->name ?></div>
            <div class="categories-sub">
                <div class="row no-gutters">
                    <div class="col-6 col-xl-3 column-1">
                        <?= $this->render('part/sub_category_block', ['cat' => $subCatFirstLevel[0]]); ?>
                    </div><!-- .col 1 -->
                    <div class="col-6 col-xl-3 column-2">
                        <?= $this->render('part/sub_category_block', ['cat' => $subCatFirstLevel[1]]); ?>
                        <?= $this->render('part/sub_category_block', ['cat' => $subCatFirstLevel[2]]); ?>
                    </div><!-- .col 2 -->
                    <div class="col col-md-12 col-xl-6 column-3">
                        <?php $subNoGutters = array_slice($subCatFirstLevel, 3);
                        foreach ($subNoGutters as $key => $noGutter) {
                            if ($key % 2 == 1) {
                                $newArray = [prev($subNoGutters), $noGutter];
                                ?>
                                <div class="row no-gutters">
                                    <?php foreach ($newArray as $item) { ?>
                                        <div class="col-6">
                                            <?= $this->render('part/sub_category_block', ['cat' => $item]); ?>
                                        </div>
                                    <?php } ?>
                                </div><!-- .row -->
                            <?php } ?>
    ...
    <section class="section section-contacts">
        <div class="container">
            <div class="h1 text-center">Помочь с выбором?</div>
            <div class="row no-gutters justify-content-lg-center">
                ...
                <div class="col phone">
                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <div class="content">
                            <a href="tel:+74956629897"><?= $setting->phone ?></a>
                        </div>
                    </div>
                </div>
                    ...
                    <ul class="d-flex footer__contacts--socials">
                        <li class="footer__contacts--social">
                            <a href="<?= $settings->facebook ?>" title="Наш facebook" target="_blank">
                                <svg width="512px" height="512px" enable-background="new 0 0 430.113 430.114"
                                     version="1.1" viewBox="0 0 430.11 430.11" xml:space="preserve"
                        ...
                        <li class="footer__contacts--social">
                            <a href="<?= $settings->google ?>" title="Наш google plus" target="_blank">
                                <svg width="512px" height="512px" enable-background="new 0 0 604.35 604.35"
                                     version="1.1" viewBox="0 0 604.35 604.35" xml:space="preserve"
                                     xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#"
                                     xmlns:dc="http://purl.org/dc/elements/1.1/"
                                     xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><metadata>
                                        <rdf:RDF>
                        ...
                        <li class="footer__contacts--social">
                            <a href="<?= $settings->linkedin ?>" title="Наш linkedin" target="_blank">
                                <svg width="512px" height="512px" enable-background="new 0 0 430.117 430.117"
                                     version="1.1" viewBox="0 0 430.12 430.12" xml:space="preserve"
                                     xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#"
                                     xmlns:dc="http://purl.org/dc/elements/1.1/"
                                     xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><metadata>
                                        <rdf:RDF>
                                    ...
                                    <path id="LinkedIn"
                                          d="m430.12 261.54v159.02h-92.188v-148.37c0-37.271-13.334-62.707-46.703-62.707-25.473 0-40.632 17.142-47.301 33.724-2.432 5.928-3.058 14.179-3.058 22.477v154.87h-92.219s1.242-251.28 0-277.32h92.21v39.309c-0.187 0.294-0.43 0.611-0.606 0.896h0.606v-0.896c12.251-18.869 34.13-45.824 83.102-45.824 60.673-1e-3 106.16 39.636 106.16 124.82zm-377.93-251.98c-31.548 0-52.183 20.693-52.183 47.905 0 26.619 20.038 47.94 50.959 47.94h0.616c32.159 0 52.159-21.317 52.159-47.94-0.606-27.212-20-47.905-51.551-47.905zm-46.706 411h92.184v-277.32h-92.184v277.32z"
                                          fill="#345c04"/>
							</svg>
                            </a>
                        </li>
                        <li class="footer__contacts--social">
                            <a href="<?= $settings->twitter ?>" title="Наш twitter" target="_blank">
                                <svg width="512px" height="512px" enable-background="new 0 0 612 612" version="1.1"
                        ...
                        <li class="footer__contacts--social">
                            <a href="<?= $settings->youtube ?>" title="Наш youtube" target="_blank">
                                <svg width="512px" height="512px" enable-background="new 0 0 511.627 511.627"
                                     version="1.1" viewBox="0 0 511.63 511.63" xml:space="preserve"
                                     xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#"
                                     xmlns:dc="http://purl.org/dc/elements/1.1/"
                                     xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><metadata>
                                        <rdf:RDF>
    ...
    <section class="seo section">
        <div class="container">
            <article class="clearfix post" id="seoFooterPost">
                <h1><?= $setting->seo_categories_title ?></h1>
                <?= $setting->seo_categories_description ?>
            </article>
        </div>
    </section>
...
<script>
    document.querySelector('.page').classList.add('page-categories-sub');
</script>
