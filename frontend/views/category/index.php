...
<main class="main" role="main">
    ...
    <section class="categories">
        <div class="container">
            ...
            <div class="h1">Напольные покрытия</div>
            <div class="d-flex flex-wrap categories-big">
                <?php foreach ($rootCategory as $item) { ?>
                    <div class="card categories-big-item">
                        <a href="<?= Yii::$app->urlManager->createUrl(['/category/view', 'id' => $item->id]) ?>"
                           class="card-img" title="<?= $item->name ?>">
            ...
            <div class="products__recommend">
                ...
                <div class="products__recommend--slider">
                    <?php foreach ($recommendProducts as $recommendProduct) {
                        echo $this->render('../site/block/main_products_part', ['type' => 'promote', 'item' => $recommendProduct]);
                    } ?>
                </div>
            </div>
        </div>
...
<script>
    document.querySelector('.page').classList.add('page-categories');
</script>
