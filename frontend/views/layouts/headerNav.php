...
<?php
$js = <<<JS
$("#J_mainCata").mouseenter(function(){
    jQuery("#J_mainCata").css({"opacity":1,"height":95,"display":"block"})
});
$("#J_mainCata").mouseleave(function(){
    //jQuery("#J_mainCata").css({"opacity":0,"height":0,"display":"none"})
});
$("#head_cart").mouseenter(function(){
    $(this).addClass('hd_cart_hover');
    $.getJSON("/cart/json-list", function(data, status) {
        if (status == "success") {
            var str = data_class = '';
            $.each(data.data, function(l, v){
            ...
            $("#head_cart").find('.list').html(str);
        }
    }).error(function(){
        $("#head_cart").find('.list').html('<p class="fail"><i class="iconfont">&#371;</i><br>购物车数据加载失败<br>请稍后再试</p>');
    });
});
$("#head_cart").mouseleave(function(){
